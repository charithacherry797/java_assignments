...
<body>
        <nav class="navbar navbar-inverse">
                ...
                <ul class=" nav navbar-nav">
                        ...
                        <li class="navbar-item"><a href="deposit.html" >Deposit</a></li>
        ...
        <form action="detailstoupdate/" method="post">
        <div>
     <lable>AccountId</lable>
      <input type="number" name="accountId"><br><br>
      
       <lable>accounTName</lable>
      <input type="text" name="accoutHolder"><br><br>
      
       <lable>Accounttype</lable>
      <input type="text" name="accountType"><br><br>
     
            <br><br> <input type="submit" value="GetDetails"><br>
 </div>
        </form>
