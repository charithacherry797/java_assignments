...
import com.capgemini.exceptionhandling.exceptions.CountryException;
import com.capgemini.exceptionhandling.exceptions.NameException;
import com.capgemini.exceptionhandling.exceptions.NotEligibleException;
import com.capgemini.exceptionhandling.main.TaxCalculator;
public class TaxCalculatorTest {
	...
	public void testToCheckValidCountry() throws CountryException, NameException {
		TaxCalculator taxCalculator = new TaxCalculator("cherry", true, 150000);

	}

	@Test(expected = CountryException.class)
	public void testToCheckNotValidCountry() throws CountryException, NameException {
		TaxCalculator taxCalculator = new TaxCalculator("cherry", false, 150000);
	...
	public void testToCaluclateTaxBetween50000And1Lakh() throws CountryException, NameException, NotEligibleException {
		TaxCalculator taxCalculator = new TaxCalculator("cherry", true, 80000);
	...
	public void testToCaluclateTaxBetween30000And50000() throws CountryException, NameException, NotEligibleException {
		TaxCalculator taxCalculator = new TaxCalculator("cherry", true, 45000);
	...
	public void testToCaluclateTaxBetween10000And30000() throws CountryException, NameException, NotEligibleException {
		TaxCalculator taxCalculator = new TaxCalculator("cherry", true, 120000);
	...
	public void testToCaluclateTaxBelow10000() throws CountryException, NameException, NotEligibleException {
		TaxCalculator taxCalculator = new TaxCalculator("cherry", true, 5000);
